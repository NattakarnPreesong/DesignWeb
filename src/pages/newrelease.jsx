...
<>
  <header className="relative flex h-64 content-center items-center justify-center ">
    <div
      className="absolute top-0 h-full w-full bg-[url('/img/newrelease.jpg')] bg-blue-gray-900  bg-cover bg-center" />
    ...
    <div className="container mx-auto">
      <div className="mt-14 flex flex-wrap">
        <div className="mx-auto w-full px-4 ">
          ...
          <Typography className="mb-3 mt-2 font-bold flex items-center text-white-gray-500">{t("New Release.message")}</Typography>
          </div>
          ...
          <Card className="shadow-lg border shadow-gray-500/10 rounded-lg">
            ...
            <CardHeader className="relative h-10 bg-gradient-to-r from-cyan-500 to-blue-500" floated={false}>
              <Typography variant="h5" color="white" className="mb-3 mt-2 font-bold flex items-center">
                <DocumentTextIcon className="ml-4 w-6 h-6 mr-2" />
                {t("New Release.message")}
              </Typography>
            </CardHeader>
